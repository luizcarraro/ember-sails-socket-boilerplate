...
module.exports.sockets = {
  ...
  ***************************************************************************/
  ...
  //   console.log('query', handshake._query.token);
  ...
  //   Jwt.findOne({token: token}).then(function (jwt) {
  //     if(!jwt) {
  //       console.log('Jwt nao encontrado');
  //       return cb(null,false);
  //     }
  //     console.log('Acessos concedido, jwt encontrado');
  //     handshake.session = { authenticated: true};
  //     return cb(null, true);
  //   })
